...
CharacterResponseModel characterResponseModelFromJson(String str) => CharacterResponseModel.fromJson(json.decode(str));

String characterResponseModelToJson(CharacterResponseModel data) => json.encode(data.toJson());
...
class CharacterResponseModel {
    ...
    factory CharacterResponseModel.fromJson(Map<String, dynamic> json) => CharacterResponseModel(
